    ...
    <div class="main">
        ...
        <section class="signup sign-up-section">
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="signup.php" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                <label for="idTelegram"><i class="zmdi zmdi-phone"></i></label>
                                <input type="text" name="idTelegram" id="idTelegram" placeholder="ID Telegram" required/>
             ...
             <div class="footer">
                        <p>© 2024 Phần mềm phát triển bởi PTTung 0359663439</p>
                    </div>
        </section>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="public/images/signin-image.jpg" alt="sign in image"></figure>
